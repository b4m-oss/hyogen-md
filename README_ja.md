...
- **Playground:** [https://hyogen-md.netlify.app](https://hyogen-md.netlify.app)（Netlify。npm パッケージには含まない）
...
| `playground/` | [Netlify](https://hyogen-md.netlify.app) 上の Vite + Vue プレイグラウンド（**npm 非同梱**） |
...
公開: **[https://hyogen-md.netlify.app](https://hyogen-md.netlify.app)**（`main` からデプロイ）。
